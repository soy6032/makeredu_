    ...
    <div>
      ...
      >
        <v-toolbar-title>
          ...
          <ul class="headerNav">
            <li class="com_fonts09 cursorPoint">
              <NuxtLink to="/makeProject" class="navText">
                프로젝트 생성
              </NuxtLink>
            </li>
            <li class="com_fonts09 cursorPoint" @click="manageProject">
                프로젝트 관리
            </li>
            <li v-if="loginState" class="com_fonts09 cursorPoint" @click="alarmBtn">
              알림
            </li>
