<template>
    <div id="template_06" style="width: 760px; margin: 0px auto;position:relative;">
        <section id="tem06_1" class="section section1 pdf-item" style="width: 760px;height: 610px;padding:30px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="inputTitle" value="6. 해커톤 대회 참가용 템플릿" maxlength="25" style="width:100%;height:50px;text-align:center;font-size:1.9rem;font-weight:600;"/>
            <div style="width:400px;margin:0 auto;margin-top:40px;">
                <input class="select" type="text" autocomplate="off" name="listInput" value="목차" maxlength="17" style="width:100%;height:45px;font-size:1.4rem;font-weight:600;"/>
        ...
        <section id="tem06_2" class="section section2 pdf-item" style="width: 760px;height: 610px;padding:10px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="summary" value="대회개요" maxlength="36" style="width:100%;height:45px;font-size:1.3rem;font-weight:600;padding-left: 10px;"/>
        ...
        <section id="tem06_3" class="section section3 pdf-item" style="width: 760px;height: 610px;padding:10px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="idea1" value="아이디어 배경" maxlength="36" style="width:100%;height:45px;font-size:1.3rem;font-weight:600;padding-left: 10px;"/>
            ...
            <div style="padding: 10px; width: 100%; height:500px">
                <div style="margin-bottom:20px;">
                    ...
                    <div style="border: 1px solid #959595;padding:0 5px 0 5px;">
                        <Textareas :widths="datas03[1].width" :heights="datas03[1].height" maxlength="188"></Textareas>
                    </div>
                </div>
                <div style="margin-bottom:20px;">
        ...
        <section id="tem06_4" class="section section4 pdf-item" style="width: 760px;height: 610px;padding:10px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="idea2" value="아이디어 제안" maxlength="36" style="width:100%;height:45px;font-size:1.3rem;font-weight:600;padding-left: 10px;"/>
            <div style="width:100%;height:3px;background:#959595;margin-top:5px;margin-bottom:10px;"></div>
            <div style="padding: 10px; width: 100%; height:500px">
                ...
                <div style="border: 1px solid #959595;padding:0 5px 0 5px;">
                    <Textareas :widths="datas04[1].width" :heights="datas04[1].height" maxlength="940"></Textareas>
                </div>
            </div>
        </section>
        <div class="html2pdf__page-break"/>
        <section id="tem06_5" class="section section5 pdf-item" style="width: 760px;height: 610px;padding:10px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="idea3" value="아이디어 제안" maxlength="36" style="width:100%;height:45px;font-size:1.3rem;font-weight:600;padding-left: 10px;"/>
            <div style="width:100%;height:3px;background:#959595;margin-top:5px;margin-bottom:10px;"></div>
            <div style="padding: 10px; width: 100%; height:500px">
                <div style="margin-bottom:5px;">
        ...
        <section id="tem06_6" class="section section6 pdf-item" style="width: 760px;height: 610px;padding:10px 0;margin: 0 auto;">
            <input class="select" type="text" autocomplate="off" name="idea" value="예상결과 및 기대효과" maxlength="36" style="width:100%;height:45px;font-size:1.3rem;font-weight:600;padding-left: 10px;"/>
            <div style="width:100%;height:3px;background:#959595;margin-top:5px;margin-bottom:10px;"></div>
            <div style="padding: 10px; width: 100%; height:500px">
                <div style="margin-bottom:5px;">
