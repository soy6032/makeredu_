  ...
  <div id="signup">
    <div class="signupWrap">
      ...
      <div class="emailWrap">
        ...
        <select v-if="!signupState" v-model="emailSelect" class="emailSelect com_input com_fonts08" name="selectEmail" @change="emailVal">
          <option v-for="(item,index) in signupSelect" :key="index" :value="item.value">
            {{ item.text }}
          </option>
        </select>
        <v-icon v-if="!signupState" class="signup_arrow">
          mdi-menu-down
        </v-icon>
